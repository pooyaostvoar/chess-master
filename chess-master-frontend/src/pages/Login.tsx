    ...
    <main className={`min-h-screen ${isMobile ? "" : "grid grid-cols-[5fr_6fr]"}`}>
      ...
      <div className={`bg-[#FAF5EB] flex flex-col justify-center ${isMobile ? "px-7 py-9" : "px-10 py-14"}`}>
        <div className="max-w-[360px] w-full mx-auto">
          ...
          {/* Error message */}
          {message && (
            <div className="mb-5 px-3.5 py-3 rounded-lg bg-[#7A2E2E]/10 border border-[#7A2E2E]/20 text-sm text-[#7A2E2E] text-center">
              {message}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-2">
              <div className="flex justify-between items-baseline mb-1.5">
                <label
                  htmlFor="login-pass"
                  className="text-sm font-medium text-[#3D2817] tracking-[0.02em]"
                >
                  Password
                </label>
              </div>
