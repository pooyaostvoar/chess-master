    ...
    <div style={styles.container}>
        ...
        <div style={styles.leftPanel}>
          ...
          <div style={styles.branding}>
            ...
            <p style={styles.brandSubtitle}>
              Connect with verified chess masters for lessons, game reviews, and live play
            </p>
            <div style={styles.featuresCard}>
              <div style={styles.features}>
                ...
                <div style={styles.feature}>
                  <span style={styles.checkmark}>✓</span>
                  <span>Chat with masters & receive session links</span>
                </div>
                <div style={styles.feature}>
                  <span style={styles.checkmark}>✓</span>
      ...
      <div style={styles.rightPanel}>
        <div style={styles.card}>
          <span style={styles.secureBadge}>Secure Sign-In</span>
          <h2 style={styles.title}>Welcome Back</h2>
          <p style={styles.subtitle}>Sign in to manage your bookings and continue</p>
