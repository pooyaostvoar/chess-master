      ...
      {!isMobile && (
        <div className="bg-[#3D2817] relative overflow-hidden text-[#F4ECDD] flex flex-col p-14">
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none" preserveAspectRatio="none">
            <defs>
              <pattern id="signupchecker" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
            ...
            <rect width="100%" height="100%" fill="url(#signupchecker)" />
          </svg>
          ...
          <div className="relative z-10">
            ...
            >
              Your first
              <br />
              <span className="italic text-[#B8893D]">move</span> starts here.
            </h1>

            <p className="text-sm text-[#F4ECDD]/70 leading-relaxed max-w-[380px]">
              Join hundreds of players learning from verified titled masters.
              Book sessions, review games, and improve — all in one place.
            </p>
          </div>
        </div>
      )}
            ...
            {masterParam && (
              <label className="flex items-center gap-2 text-[12px] text-[#3D2817] mt-1 cursor-pointer select-none">
                <input
                  ...
                  className="w-3.5 h-3.5 accent-[#B8893D]"
                />
                I am a titled player (master)
              </label>
            )}
