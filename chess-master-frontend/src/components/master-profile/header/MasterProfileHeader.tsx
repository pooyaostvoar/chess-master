      ...
      <div className="flex items-start gap-6 p-4 sm:p-8 justify-between">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="flex flex-col items-center gap-2 w-full sm:w-auto">
            <button
              className="flex items-center justify-center gap-2 rounded-2xl bg-white px-2 md:px-6 py-2 text-xs font-semibold text-slate-900 transition hover:bg-slate-100"
