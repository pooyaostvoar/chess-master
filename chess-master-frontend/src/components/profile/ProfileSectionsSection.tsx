  ...
  return (
    <section>
      ...
      <div className="space-y-4">
        {sections.length === 0 && (
          <div className="rounded-lg border border-dashed border-[#1F1109]/[0.14] bg-[#F4ECDD]/40 px-4 py-5 text-center text-sm text-[#6B5640]">
            No profile tabs yet.
          </div>
        )}
        ...
        {sections.map((section, index) => (
          ...
          >
            <div className="flex items-center justify-between gap-3 mb-3">
              <div className="text-sm font-medium text-[#3D2817]">
                Tab {index + 1}
              </div>
              <button
                type="button"
            ...
            <label className="block text-sm font-medium text-[#3D2817] mt-3 mb-1.5 tracking-[0.02em]">
              Content
            </label>
            <textarea
