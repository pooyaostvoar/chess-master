          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-8">
              {!isMobile && (
                <Link
                  to="/home"
                  className="text-base font-medium text-[#F4ECDD]/80 hover:text-[#F4ECDD] transition-colors"
                >
                  Home
                </Link>
              )}
              ...
              {loading ? (
                  ...
                  <DropdownMenuContent align="end" className="w-56 bg-[#FAF5EB] border-[#1F1109]/[0.12]">
                    <DropdownMenuLabel>
                      <div className="flex flex-col space-y-0.5">
                        ...
                        <p className="text-sm text-[#B8893D]">
                    ...
                    >
                      ...
                      {unreadCount > 0 && (
                        <span className="bg-[#7A2E2E] text-white text-xs font-bold rounded-full min-w-[18px] h-[18px] px-1.5 flex items-center justify-center">
                          {unreadCount > 99 ? "99+" : unreadCount}
                        </span>
                      )}
                    </DropdownMenuItem>
                ...
                <div className="flex items-center gap-5">
                  ...
                  <button
                    ...
                    className="bg-[#B8893D] text-[#1F1109] px-4 py-2 rounded-full text-base font-medium hover:bg-[#A67B30] transition-colors"
                  >
                    Sign up
                  </button>
                </div>
          ...
          <div className="max-w-5xl mx-auto px-5 sm:px-8 pt-12 pb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-[1.4fr_1fr_1fr] gap-8 mb-9">
              ...
              <div>
                ...
                />
                <p className="text-sm text-[#F4ECDD]/55 leading-relaxed mb-4">
              ...
              {/* Navigate column */}
              <div>
                <div className="text-xs font-medium text-[#F4ECDD]/50 tracking-[0.08em] uppercase mb-3.5">Navigate</div>
                <div className="flex flex-col gap-2">
                  <a onClick={() => navigate("/masters")} className="text-sm text-[#F4ECDD]/85 hover:text-[#F4ECDD] cursor-pointer transition-colors">Browse masters</a>
                  <a onClick={() => { const el = document.getElementById("how-it-works"); if (el) el.scrollIntoView({ behavior: "smooth" }); else navigate("/home#how-it-works"); }} className="text-sm text-[#F4ECDD]/85 hover:text-[#F4ECDD] cursor-pointer transition-colors">How it works</a>
                  <a onClick={() => navigate("/events")} className="text-sm text-[#F4ECDD]/85 hover:text-[#F4ECDD] cursor-pointer transition-colors">From the archive</a>
                </div>
              </div>

              {/* Connect column */}
              <div>
                <div className="text-xs font-medium text-[#F4ECDD]/50 tracking-[0.08em] uppercase mb-3.5">Connect</div>
                <div className="flex flex-col gap-2">
                  <a onClick={() => navigate("/signup")} className="text-sm text-[#F4ECDD]/85 hover:text-[#F4ECDD] cursor-pointer transition-colors">Become a master</a>
                  <a href="mailto:team@chesswithmasters.com" className="text-sm text-[#F4ECDD]/85 hover:text-[#F4ECDD] transition-colors">team@chesswithmasters.com</a>
                  <a
                    href="https://wa.me/37256372739"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#B8893D]/15 border border-[#B8893D]/40 rounded-full text-sm text-[#B8893D] font-medium w-fit hover:bg-[#B8893D]/25 transition-colors"
                  >
            ...
            <div className="border-t border-[#F4ECDD]/[0.12] pt-5 flex justify-between items-center gap-4 flex-wrap">
              <span className="text-sm text-[#F4ECDD]/45">
